...
enum DataVC: String {
    case userManagement = "Gestion des utilisateurs"
    case moderation = "Modération"
    case option1 = "En développement"
    case option2 = "En développement "
    case option3 = "En développement  "
    case option4 = "En développement   "
}

class AdministrationController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    
    @IBOutlet weak var customTableView: UITableView!
    
    let datas: [DataVC] = [.userManagement, .moderation, .option1, .option2, .option3, .option4]
    ...
    func pushViewController(_ dataVC: DataVC) {
        ...
        switch dataVC {
        case .userManagement:
            nextViewController = storyboard.instantiateViewController(withIdentifier: "userManagementController") as! UserManagementController
        case .moderation:
